...
最终用户在[应用市场](https://appcenter.shanhe.com/)上可以浏览服务商提供的 App 并创建 App 实例。
...
使用者在创建该 App 实例的时候，山河的调度系统会根据这个配置包定义的信息创建基础资源，
然后注册集群信息到山河为每个 VPC 环境下部署的 metadata service 中，
