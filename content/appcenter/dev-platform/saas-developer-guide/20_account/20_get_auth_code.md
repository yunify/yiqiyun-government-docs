...
```
https://account.yiqiyun.com/sso/oauth2?response_type=code&client_id=app-8r2f7oyr
```
...
```
http://console.yiqiyun.com/app/app-8r2f7oyr/apply?code=FPNRDSJGKEZZPFIDIWTA
```
