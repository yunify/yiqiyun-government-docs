---
title: "计费说明"
description: 本小节主要介绍 Strom  计费说明。 
keywords: Strom  计费说明, 
weight: 10
collapsible: false
draft: false
...
shanhe账号支持多种充值途径：支付宝、网上银行、微信支付、线下银行转账。 微信支付目前只能在 Android 手机的shanhe App 中操作。

shanhe执行按用量收费原则。您只需为使用的资源付费。费用按秒计算，且不设最低消费指标。

您随时可以在 Web 控制台中查询消费情况。

## 余额不足提醒

shanhe系统会定期检查用户余额和当时名下弹性计费资源的消费预估， 如果检查发现余额即将不足，会提前给用户发送通知。
