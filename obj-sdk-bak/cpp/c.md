...
在开始使用 SDK 之前，请确认您已经了解 [山河 QingStor 对象存储基本概念](https://docs.shanhe.com/qingstor/api/common/overview.html) ，如 Zone，Service，Bucket，Object 等。
...
shanhe 用户。下面我们将会演示如何通过 API 接口来获取和设置 Bucket
ACL。
...
所有的 API 调用接口均与上面的示例相似，您可以访问 [山河 QingStor 对象存储
API 文档](https://docs.shanhe.com/qingstor/api/index.html)
来了解更多讯息。
